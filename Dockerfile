...
RUN apt-get update && \
    apt-get install -y composer mysql-server git php7.0-cli php7.0-curl curl bzip2 libxslt1.1 libmcrypt4 libcurl3 \
                       ...
                       libcurl4-openssl-dev libenchant-dev libpng16-dev libgmp3-dev libc-client2007e-dev libkrb5-dev \
                       firebird-dev libldap2-dev && \
                       ln -s /usr/include/x86_64-linux-gnu/gmp.h /usr/include/gmp.h && \
                       ln -s /usr/lib/libc-client.a /usr/lib/x86_64-linux-gnu/libc-client.a


RUN curl -L https://github.com/phpbrew/phpbrew/raw/master/phpbrew>/usr/bin/phpbrew && \
